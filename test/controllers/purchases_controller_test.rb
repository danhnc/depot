...
class PurchasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase" do
    assert_difference('Purchase.count') do
      post purchases_url, params: { purchase: { cart_id: @purchase.cart_id, order_id: @purchase.order_id } }
    end
  ...
  test "should update purchase" do
    patch purchase_url(@purchase), params: { purchase: { cart_id: @purchase.cart_id, order_id: @purchase.order_id } }
